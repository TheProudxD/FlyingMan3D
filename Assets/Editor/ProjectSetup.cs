...
public static class ProjectSetup
{
    ...
    {
        Folders.Create("_Project", "UI", "Fonts", "Animations/AnimationClips",
            "Animations/Animators", "Models", "Sprites", "Shaders", "Materials", "Audio/AudioClips", "PhysicMaterials",
            "Prefabs", "Scripts/Tests", "Scripts/Tests/Editor",
