...
namespace _Project.Scripts.Infrastructure.Services.Audio
{
    ...
    public class AudioConfig : Config.Config
    {
        ...
        [field: SerializeField] public AudioClip Money { get; private set; }
        [field: SerializeField] public AudioClip Launch { get; private set; }
        [field: SerializeField] public AudioClip Die { get; private set; }
        [field: SerializeField] public AudioClip RingCollide { get; private set; }
