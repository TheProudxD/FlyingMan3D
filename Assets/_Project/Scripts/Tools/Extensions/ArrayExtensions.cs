...
namespace _Project.Scripts.Tools.Extensions
{
    public static class ArrayExtensions
    {
        ...
        public static TL InitWith<TL, T>(this TL list, T with, int count) where TL : IList<T>
        {
            list.Clear();
        ...
        public static TL InitWith<TL, T>(this TL list, Func<T> with, int count) where TL : IList<T>
        {
            list.Clear();
        ...
        public static TL InitWith<TL, T>(this TL list, Func<int, T> with, int count) where TL : IList<T>
        {
            list.Clear();
        ...
        public static IOrderedEnumerable<T> Shuffle<T>(this IOrderedEnumerable<T> target, System.Random random) =>
            target.OrderBy(x => random.Next());
        
        public static int RandomIndex<T>(this T[] array) => Random.Range(0, array.Length);

        public static T RandomElement<T>(this T[] array) =>
            array.IsNullOrEmpty() ? default(T) : array[RandomIndex(array)];
