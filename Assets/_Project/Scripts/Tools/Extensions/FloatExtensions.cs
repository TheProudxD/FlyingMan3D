...
namespace _Project.Scripts.Tools.Extensions
{
    public static class FloatExtensions
    {
        ...
        public static bool BetweenStrictly(this float target, float min, float max) => target > min && target < max;

        public static bool Between(this float target, float min, float max) => target >= min && target < max;
