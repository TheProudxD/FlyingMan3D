...
namespace _Project.Scripts.Tools.Extensions
{
    public static class Vector3Extensions
    {
        ...
        public static Vector3 ClampSimmetrical(this Vector3 value, Vector3 center,
            ...
            new(Mathf.Clamp(value.x, center.x - marginX, center.x + marginX),
        ...
        {
            Vector3 substractedVector = v - vectorToSubstract;
        ...
        public static Vector3 GetRandom(this Vector3 vector3) =>
            new(Random.Range(-1f, 1f), Random.Range(-1f, 1f), Random.Range(-1f, 1f));

        public static Vector3 GetRandomNormalized(this Vector3 vector3) => GetRandom(vector3).normalized;
    }
}