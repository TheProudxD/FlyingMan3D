...
namespace _Project.Scripts.Tools.Extensions
{
    public static class IntExtensions
    {
        ...
        public static bool BetweenStrictly(this int target, int min, int max) => target > min && target < max;

        public static bool Between(this int target, int min, int max) => target >= min && target < max;
